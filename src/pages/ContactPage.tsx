    ...
    <form onSubmit={submit} className="border border-gray-200 dark:border-[#00ff66]/20 rounded-2xl bg-white dark:bg-[#040c06]/60 backdrop-blur p-6 md:p-8 space-y-5 shadow-lg dark:shadow-none font-sans transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <label htmlFor="contact-name" className="flex items-center gap-1.5 text-xs font-semibold text-gray-700 dark:text-[#88aa90] tracking-wide uppercase">
            <User className="w-3.5 h-3.5 text-emerald-600 dark:text-[#00ff66]" /> Name <span className="text-red-500">*</span>
          </label>
          <input id="contact-name" type="text" name="name" autoComplete="name" value={form.name} onChange={handle} required
        ...
        <div className="space-y-1.5">
          <label htmlFor="contact-email" className="flex items-center gap-1.5 text-xs font-semibold text-gray-700 dark:text-[#88aa90] tracking-wide uppercase">
            <Mail className="w-3.5 h-3.5 text-emerald-600 dark:text-[#00ff66]" /> Email <span className="text-red-500">*</span>
          </label>
          <input id="contact-email" type="email" name="email" autoComplete="email" value={form.email} onChange={handle} required
      ...
      <div className="space-y-1.5">
        <label htmlFor="contact-subject" className="flex items-center gap-1.5 text-xs font-semibold text-gray-700 dark:text-[#88aa90] tracking-wide uppercase">
          <FileText className="w-3.5 h-3.5 text-emerald-600 dark:text-[#00ff66]" /> Subject
        </label>
        <select id="contact-subject" name="subject" value={form.subject} onChange={handle}
      ...
      <div className="space-y-1.5">
        <label htmlFor="contact-message" className="flex items-center gap-1.5 text-xs font-semibold text-gray-700 dark:text-[#88aa90] tracking-wide uppercase">
          <MessageSquare className="w-3.5 h-3.5 text-emerald-600 dark:text-[#00ff66]" /> Message <span className="text-red-500">*</span>
        </label>
        <textarea id="contact-message" name="message" value={form.message} onChange={handle} required rows={5}
