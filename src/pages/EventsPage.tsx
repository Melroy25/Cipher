...
let cachedEvents: EventData[] = [...DEFAULT_EVENTS];
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (Array.isArray(json.data) && json.data.length > 0) {
          cachedEvents = json.data.map((e: any) => ({
            id: e.id,
            tag: e.tag || "EVENT",
    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 font-sans">
      ...
      {featuredEvent && (
        ...
        >
          ...
          <div className="relative h-72 md:h-96 w-full overflow-hidden">
            <img
              src={
                featuredEvent.slides[0] ||
                (featuredEvent.title.toLowerCase().includes("lumière") || featuredEvent.title.toLowerCase().includes("lumiere")
                  ? "/assets/lumiere/slide_01.jpg"
                  : "/assets/promptops/slide_01.jpg")
              }
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = featuredEvent.title.toLowerCase().includes("lumière") || featuredEvent.title.toLowerCase().includes("lumiere")
                  ? "/assets/lumiere/slide_01.jpg"
                  : "/assets/promptops/slide_01.jpg";
              }}
            />
      ...
      <div className="mt-20 pt-10 border-t border-gray-200 dark:border-[#00ff66]/15 relative">
        ...
        <div className="relative w-full overflow-hidden py-4 rounded-2xl bg-gray-50/80 dark:bg-[#030904]/90 border border-gray-200 dark:border-[#00ff66]/20 backdrop-blur-md shadow-inner">
          ...
          {/* Marquee track */}
          <div className="animate-marquee flex items-center gap-4 sm:gap-6 will-change-transform">
            {[0, 1].map((copyIndex) => (
