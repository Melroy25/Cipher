        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4 font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label htmlFor="join-name" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
                  Full Name *
                </label>
                <input
                  id="join-name"
              ...
              <div>
                <label htmlFor="join-email" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label htmlFor="join-phone" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
                  Phone Number
                </label>
                <input
                  id="join-phone"
              ...
              <div>
                <label htmlFor="join-usn" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
                  USN (College ID)
                </label>
                <input
                  id="join-usn"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label htmlFor="join-semester" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
                  Semester / Year
                </label>
                <select
                  id="join-semester"
              ...
              <div>
                <label htmlFor="join-domain" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
                  Domain Preference
                </label>
                <select
                  id="join-domain"
            ...
            {/* Skills / Background */}
            <div>
              <label htmlFor="join-skills" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
            ...
            {/* Reason */}
            <div>
              <label htmlFor="join-reason" className="block text-xs font-semibold text-gray-700 dark:text-[#00ff66] mb-1.5 uppercase tracking-wide">
