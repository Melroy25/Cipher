...
export const PublicLayout: React.FC = () => {
  ...
  return (
    <div className="public-site-cursor min-h-screen bg-white dark:bg-[#030804] text-gray-900 dark:text-white font-sans selection:bg-[#00ff66] selection:text-black relative transition-colors duration-200 overflow-x-hidden">
      ...
      <div className={`transition-opacity duration-700 ${isBooting ? "opacity-0" : "opacity-100"}`}>
        ...
        <div className="relative z-10 pt-24 min-h-[calc(100vh-200px)]">
          <Outlet context={{ onOpenJoinModal: () => setIsJoinModalOpen(true), onOpenRootAccess: () => setIsRootAccessOpen(true) }} />
        </div>
